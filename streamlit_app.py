...
.stButton button { border-radius: 12px; background: white; border: 1px solid #e2e8f0; color: #1e3a5f; padding: 8px 12px; font-size: 14px; width: 100%; }
...
/* IMPORTANTE: Esto fuerza la cuadrícula en móvil */
...
# ========== NÚMEROS EN CUADRÍCULA 10x10 ==========
# Usar st.columns para forzar 10 columnas por fila
for fila in range(10):
    # Crear 10 columnas para esta fila
    cols = st.columns(10)
...
if 'numero_seleccionado' in st.session_state:
    ...
    if estado_actual != "Disponible":
        ...
        with st.form("compra_form"):
            ...
            telefono = st.text_input("📱 Teléfono *", placeholder="Ej: 3826448225")
